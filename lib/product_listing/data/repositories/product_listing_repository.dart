...
class ProductListingRepository {
  ...
  ProductListingResult _mockResult({
    ...
    if (start >= all.length)
      return const ProductListingResult(products: [], hasMore: false);
  ...
  static final List<ProductModel> _catalogue = [
    ...
    ProductModel(
      id: 'sun4',
      name: 'Anti-Age Sunscreen SPF 30',
      imageUrl: 'assets/images/cream.webp',
      price: 27.00,
      rating: 4.6,
      isWishlisted: false,
